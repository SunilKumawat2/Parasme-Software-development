...
const Header = () => {
  ...
  // This UseState Use for the Navabr Hide and Show
  ...
  const subMenu = null;
  const subMenu2 = null;
  // Show the Window after Scroll the 
  useEffect(() => {
    const handleScroll = () => {
  ...
  const formHandleSubmit = (e) => {
    ...
    setLoading(true);
    axios
      .post(`${API_BASE_URL}/messagebox/post`, {
        name,
        email,
        phone,
        country,
...
console.log("PPC",PPC)
  ...
  return (
    <div>
      <header
        className={`header header_section darkHeader ${isDarkHeader ? "active" : "hidden"
          }`}
      >
                  ...
                  <>
                    {HeaderLogoResult ? (
                      <Link to="/" className="logo fixed-logos">
                        <img src={`http://localhost:4000/photos/${HeaderLogoResult?.logo}`} alt="HeaderLogo" />

                        <Link>
                          <Link to="/" className="logo02 fixed-logos">
                            <img src={`http://localhost:4000/photos/${HeaderLogoResult?.logo}`} className="img" alt="HeaderLogo" />
                          </Link>
                        </Link>
                      </Link>
                    ) : (
                      <Link to="/" className="logo fixed-logos">
                        ...
                        <Link>
                          <Link to="/" className="logo02 fixed-logos">
                            <img src={logo} className="img" alt="HeaderLogo" />
                          </Link>
                        </Link>
                      </Link>
                    )}
                    ...
                    >
                      ...
                      <div className="list-item col-md-3">
                        ...
                        <ul>
                          ...
                          {/* <li>
                            <Link to="/Creativeportfolio">
                              Creative Portfolio Sites
                            </Link>
                          </li>
                          <li>
                            <Link to="/ResponsiveWebDesign">
                        ...
                        <ul>
                          ...
                          {/* <li>
                            <Link to="/Ecommercewebhosting">
                              E Commerce Web Hosting
                            </Link>
                          </li>
                          <li>
                            <Link to="/Woocommercedevelopment">
                              WooCommerce Development
                            </Link>
                          </li>
                          <li>
                            <Link to="/SSLCertificates">SSL Certificates</Link>
                          </li>
                          <li>
                      ...
                      <div className="list-item col-md-3">
                        ...
                        <ul>
                          ...
                          {/* <li>
                            <Link to="/DisplayNetwork">Display Network</Link>
                          </li>
                          <li>
                            <Link to="/VideoAdvertising">
                              Video Advertising
                            </Link>
                          </li>
                          <li>
                            <Link to="/ShoppingAds">Shopping Ads</Link>
                          </li>
                          <li>
                            <Link to="/Remarketing">Remarketing</Link>
                          </li>
                          <li>
                            <Link to="/MobileMarketing">Mobile Marketing</Link>
                          </li>
                          <li>
                            <Link to="/ApplicationMarketing">
                              Application Marketing
                            </Link>
                          </li>
                          <li>
                            <Link to="/GmailAds">Gmail Ads</Link>
                          </li>
                          <li>
                            <Link to="/DynamicReporting">
                              Dynamic Reporting
                            </Link>
                          </li> */}
                        </ul>
                    ...
                    >
                      <div className="list-item col-md-5 mt-2">
                        <ul>
                          ...
                          {/* <li>
                            <Link to="/Bespokeseopackages">
                              Bespoke SEO Packages
                            </Link>
                          </li>
                          <li>
                            <Link to="/ConversionOptimization">
                              Conversion Optimization
                            </Link>
                          </li>
                          <li>
                            <Link to="/ECommerceSEOProcess">
                              E-Commerce SEO Process
                            </Link>
                          </li>
                          <li>
                            <Link to="/SEOSiteAnalysis">SEO Site Analysis</Link>
                          </li>
                          <li>
                            <Link to="/GoogleTools">Google Tools</Link>
                          </li>
                          <li>
                            <Link to="/LocalSEOProcess">Local SEO Process</Link>
                          </li>
                          <li>
                            <Link to="/SEOSoftware">SEO Software</Link>
                          </li> */}
                        </ul>
                      </div>
                    ...
                    return (
                      <>
                        <li>
                          {socialMediaResult ? (
                            <Link
                              to={socialMediaResult?.facebook_link}
                              target="_blank"
                            >
                        ...
                        <li>
                          {socialMediaResult ? (
                            <Link
                              to={socialMediaResult?.tiwtter_link}
                              target="_blank"
                            >
                        ...
                        <li>
                          {socialMediaResult ? (
                            <Link
                              to={socialMediaResult?.instagram_link}
                              target="_blank"
                            >
                        ...
                        <li>
                          {socialMediaResult ? (
                            <Link
                              to={socialMediaResult?.behance_link}
                              target="_blank"
                            >
                        ...
                        <li>
                          {socialMediaResult ? (
                            <Link
                              to={socialMediaResult?.youtube_link}
                              target="_blank"
                            >
                        ...
                        <li>
                          {socialMediaResult ? (
                            <Link
                              to={socialMediaResult?.linkdin_link}
                              target="_blank"
                            >
