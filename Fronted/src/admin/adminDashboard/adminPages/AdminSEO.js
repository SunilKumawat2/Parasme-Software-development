...
const AdminSEO = () => {
    ...
    const HandleSubmit = (e) => {
        ...
        axios.post(`${API_BASE_URL}/SEO/post`, formData).then((response => {
    ...
    const deleteSEOS = async (_id) => {
        try {
            const response = await axios.delete(`${API_BASE_URL}/SEO/delete/${_id}`);
            console.log(response.data);
            GetSEO();
        } catch (error) {
            console.error(error);
    ...
    console.log("AllPortFoliosById", AllPortFoliosById)
    ...
    const EditSEOS = async (_id) => {
        ...
        if (editFormData.images || editFormData.title || editFormData.description
            ...
            try {
                const response = await axios.put(`${API_BASE_URL}/SEO/update/${_id}`, formData);
                console.log(response.data);
                                    ...
                                    <form
                                        onSubmit={(e) => {
                                            ...
                                            if (AllPortFoliosById && AllPortFoliosById._id) {
                                                EditSEOS(AllPortFoliosById._id);
                                            } else {
                                    ...
                                    >
                                        ...
                                        <div className='EditAllPortFoliosInput'>
                                            <div className='EditAllPortFoliosInputInput'>
                                                <img
                                                    src={`${IMG_BASE_URL}${editFormData.images ||
                                                        AllPortFoliosById?.images}`}
                                                    alt='Slider'
                                                    style={{
                                                        width: "180px",
                                                        height: "100px",
                                    ...
                                    return (
                                        <>
                                            <tr>
                                                ...
                                                <td dangerouslySetInnerHTML={{ __html: `${AllPortFoliosResult?.about_page?.slice(0, 50)}...` }} />
                                                <td>
                                                    <MdDelete style={{
                                                ...
                                                <td>
                                                    <LiaEdit variant="primary" onHide={handleCloseEdit}
                                                        ...
                                                        onClick={() => {
                                                            handleShowEdit();
                                                            GetSEOById(AllPortFoliosResult?._id);
                                                        }}
                                                        style={{
                                                            cursor: "pointer", fontSize: '25px'
